...
0x55, 0xaa, 0xeb, 0x90, 0x03, 0x4b, 0x4a, 0x4b, 0x5f, 0x42, 0x44, 0x36, 0x41, 0x32, 0x30, 0x53,
0x31, 0x30, 0x50, 0x00, 0x00, 0x00, 0x31, 0x31, 0x2e, 0x58, 0x57, 0x00, 0x00, 0x00, 0x31, 0x31,
0x2e, 0x32, 0x38, 0x31, 0x00, 0x00, 0xa8, 0x6b, 0x09, 0x01, 0x35, 0x00, 0x00, 0x00, 0x4a, 0x4b,
...
TEST_CASE("checkParseDeviceInfo", "[JkBmsFrames]") {
    ...
    std::cout << "Vendor ID: " << info.vendorId << " eq=" << (info.vendorId == "JK_BD6A20S10P") << std::endl;
    REQUIRE(info.vendorId == "JK_BD6A20S10P");
    REQUIRE(info.hwVersion == "11.XW");
    REQUIRE(info.swVersion == "11.281");
    REQUIRE(info.uptimeSeconds == 67800);
